# Corso di Sviluppo Web Avanzato<br/>*Progetti A.A. 2025/2026* - Specifica 1

<section class="specifica">

## Progetto "WebDelivery Services"
> Versione 1.0
...
A partire dalle strutture dati del progetto *WebDelivery*
...
2. Lettura del del menu completo (*lista dei prodotti con tutte le informazioni visibili al cliente, comprese le relative caratteristiche con la differenza di prezzo*).
3. Ricerca prodotti nel menu un base al nome e/o alla fascia di prezzo (*presso minimo e/o massimo*).
4. Eliminazione di una caratteristica associata a un prodotto.
5. Inserimento di un prodotto in un ordine, comprensivo delle sue eventuali caratteristiche.
6. Estrazione del tempo stimato di consegna e del prezzo totale di un ordine (*due endpoint distinti*).
7. Aggiornamento dello stato di un ordine.
8. Lista degli ordini filtrati per data di inserimento e stato corrente.
9. Estrazione ordini effettuati da un determinato utente.
10. Lista degli ingredienti necessari alla preparazione di un particolare prodotto del menu.
11. Lista degli operatori coinvolti nella gestione di un certo ordine.
12. Annullamento (eliminazione) di un ordine.
13. Lista dei prodotti presenti in un ordine, comprensivi delle loro eventuali caratteristiche.
...
In particolare, il client dovrà permettere di eseguire opportunamente le operazioni 1, 2, 3, 8 e 12.  
